...
export default function CatalogueClient({ products }: Props) {
    ...
    return (
        <div style={{ background: "#f5f4f0", padding: "24px 32px" }}>
            <div
                style={{
                    display: "grid",
            ...
            >
                        ...
                        {["tous", "neuf", "occasion"].map((val) => (
                            <label
                                ...
                                style={{
                                    ...
                                    gap: 10,
                                    fontSize: 13,
                                    color: condition === val ? "#e63012" : "#555",
                                    marginBottom: 10,
                                    cursor: "pointer",
                        ...
                        {CATEGORIES.map((cat) => (
                            <label
                                ...
                                style={{
                                    ...
                                    gap: 10,
                                    fontSize: 13,
                                    color: category === cat.value ? "#e63012" : "#555",
                                    marginBottom: 10,
                                    cursor: "pointer",
                ...
                <div>
                    ...
                    >
                        <span>
                            <strong style={{ color: "#1a1a2e" }}>{filtered.length}</strong> produit
